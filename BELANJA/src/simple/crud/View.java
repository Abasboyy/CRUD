...
public class View extends javax.swing.JFrame {
    ...
    public void loadData(){
      try {
        ...
        String url = "jdbc:MySQL://localhost:3306/belanja_db";
        String user = "root";
        String pass = "";
       ...
       DefaultTableModel model = new DefaultTableModel(new String[]{"ID", "Nama Barang", "Harga Barang", "Satuan Barang"}, 0);
       ...
       while(rs.next()){
         i = rs.getString("id");
         f = rs.getString("nama_barang");
         l = rs.getString("harga_barang");
         e = rs.getString("satuan_barang");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try {
            ...
            if("".equals(fName.getText())){
                ...
                JOptionPane.showMessageDialog(new JFrame(), "Masukan Nama Barang", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
            }else if("".equals(lName.getText())){
             
                JOptionPane.showMessageDialog(new JFrame(), "Masukan Harga Barang", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
            }else if("".equals(email.getText())){
             
                JOptionPane.showMessageDialog(new JFrame(), "Masukan Satuan Barang", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
            }else {
                fN = fName.getText();
                lN = lName.getText();
                em = email.getText();
                query = "INSERT INTO user (nama_barang, harga_barang, satuan_barang) "
                        + "VALUES ('"+fN+"','"+lN+"','"+em+"')";
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            ...
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "Masukan Nomor", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
            }else {
               ...
               while(rs.next()){
                 ...
                 lN = lName.getText();
                 em = email.getText();
                 String sql2 = "UPDATE user SET nama_barang='"+fN+"', harga_barang='"+lN+"', satuan_barang='"+em+"'  WHERE id="+ID;
                 st.executeUpdate(sql2); 
                 loadData();
                 con.close();
               }
               if(notFound == 0){
                  JOptionPane.showMessageDialog(new JFrame(), "Nomor Salah", "Dialog",
                                     JOptionPane.ERROR_MESSAGE);
               }
            }
        }catch(Exception e){
        ...
        try {
            ...
            if("".equals(ID)){
              JOptionPane.showMessageDialog(new JFrame(), "Masukan Nomor", "Dialog",
               ...
               ResultSet rs = st.executeQuery(sql);
               while(rs.next()){
                   fName.setText(rs.getString("nama_barang"));
                   lName.setText(rs.getString("harga_barang"));
                   email.setText(rs.getString("satuan_barang"));
                   notFound = 1;
